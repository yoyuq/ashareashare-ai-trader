"""价值质量复合选股 V2 (数据完整性修正重测) — 预注册 reports/agent_loop/prereg_value_quality_v2.md (iter31).
...
输出: reports/agent_loop/value_quality_v2_result.json
"""
...
def main() -> int:
    ...
    fp = ROOT / "reports" / "agent_loop" / "value_quality_v2_result.json"
